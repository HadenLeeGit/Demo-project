...
import { getUserData, pushData, getAllUsers, ok } from "./Firebase";
...
function Dashboard(props) {
  ...
  const [selectedOption, setSelectedOption] = useState("anotheruser");
  ...
  const getData = () => {
    setData(getUserData(selectedOption))
    ...
    isAuthenticated && (
      <div className="dashboard">
        ...
        <div className="dashboardContainer">
          <Navbar />
          <p>Data for user: "{selectedOption}"</p>
          <Select
            value={selectedOption}
            onChange={handleChange}
            options={listUsers}>
          </Select>
          {/* <Button onClick={filterByDay} variant="outline-dark">Day</Button>{' '}
          <Button onClick={filterByMonth} variant="outline-dark">Month</Button>{' '}
          <Button onClick={filterByYear} variant="outline-dark">Year</Button>{' '}  */}
          {/* <Button onClick={resetFilter} variant="outline-dark">Reset</Button>{' '} */}
